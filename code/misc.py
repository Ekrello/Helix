def helpmusic():
    ...
    helpmsg1 += "/supported         <--All the links Helix supports\n"
...
def helputility():
    ...
    helpmsg2 += "/feature           <--Request a feature to be added to Helix\n"
...
def helpadmin():
    ...
    helpmsg3 += "/clean             <--Remove all Helix related spam\n"
